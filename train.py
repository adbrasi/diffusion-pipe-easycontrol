...
if __name__ == '__main__':
    ...
    elif model_type == 'ideogram4_identity_nextscene':
        from models import ideogram4_identity_nextscene
        model = ideogram4_identity_nextscene.Ideogram4IdentityNextScenePipeline(config)
